# Pin Copy Library — Days 31-42 Addendum (Phase 2)

**This is the addendum to `Pin Copy Library - UPDATED.md`.** Same format. Same Pinterest-validated hashtag approach. Append the contents of this file to that one (or keep them side by side — both reference the same `final pins/02-affiliate-pins/` folder).

For each pin: title is the headline, description is 2-3 sentences ending with the affiliate disclosure `(As an Amazon Associate I earn from qualifying purchases.)`, then 5 hashtags.

---

# PHASE 2 — DAYS 31-42 (60 BONUS PINS, FURNITURE + BEDROOM FEATURE WEEKS)
...
### Pin 159 | 7 PM | Lighting | `day32-pin159-evening-lamp-glow.png`
**Title:** Evening lamp glow
**Desc:** A single warm bulb in a stoneware lamp throws long shadow across linen. The hour the day softens. Tap to shop the lamp.
`#cozyhome #lighting #moodylighting #cozyvibes #homedecor`
(As an Amazon Associate I earn from qualifying purchases.)

### Pin 160 | 10 PM | Furniture | `day32-pin160-linen-bench.png`
**Title:** Linen bench at the foot of the bed
**Desc:** Upholstered linen bench in stone, oak legs, just deep enough for tomorrow's clothes. Tap to shop.
`#bedroomdecor #bedroombench #linen #neutralhome #scandinavianstyle`
(As an Amazon Associate I earn from qualifying purchases.)
...
### Pin 163 | 3 PM | Office/Reading Nook | `day33-pin163-three-desk-objects.png`
**Title:** 3 desk objects that calm the eye
**Desc:** A stoneware mug for pens, a small ribbed vase, a leather-wrapped notebook. Three objects, no clutter. Tap each.
...
### Pin 166 | 8 AM | Furniture | `day34-pin166-open-living-getthelook.png`
**Title:** Get the look — an open living room
**Desc:** Cream linen sofa, oak coffee table, jute rug, ribbed vase, wool throw. Five anchor pieces, one quiet room. Tap each numbered item.
`#livingroomdecor #homedecor #livingroominspo #scandinavianstyle #neutralhome`
(As an Amazon Associate I earn from qualifying purchases.)

### Pin 167 | 12 PM | Lighting | `day34-pin167-breakfast-pendant.png`
**Title:** Breakfast pendant for the kitchen
**Desc:** Single rattan dome pendant over a small breakfast table. Warm bulb, soft morning, no overhead glare. Tap to shop.
...
### Pin 169 | 7 PM | Bedroom | `day34-pin169-compact-bed-frame.png`
**Title:** Compact bed frame for small rooms
**Desc:** Low-profile oak bed frame, narrow footprint, perfect for under-eight-foot ceilings. Reads bigger than it is. Tap to shop.
`#bedroomdecor #bedframe #smallbedroom #oakfurniture #scandinavianstyle`
(As an Amazon Associate I earn from qualifying purchases.)

### Pin 170 | 10 PM | Textiles | `day34-pin170-boucle-pillows.png`
**Title:** Boucle pillows ($35 each)
**Desc:** Cream boucle throw pillows on a linen sofa. Texture for cheap, swap for the season. Tap to shop the set.
`#bouclepillows #throwpillows #livingroomdecor #cozyhome #neutralhome`
(As an Amazon Associate I earn from qualifying purchases.)
...
### Pin 173 | 3 PM | Storage | `day35-pin173-four-bins-shelf.png`
**Title:** 4 bins for an open shelf
**Desc:** Linen, woven seagrass, wood crate, lidded fabric. Four bins, one open shelf, instant calm. Tap each.
...
### Pin 178 | 3 PM | Outdoors | `day36-pin178-cordless-patio-lamp.png`
**Title:** Cordless patio lamp
**Desc:** Battery-powered LED table lamp, looks like a real lamp, runs for hours. Patio dinners without the extension cord. Tap to shop.
...
### Pin 181 | 8 AM | Furniture | `day37-pin181-week5-furniture-roundup.png`
**Title:** Week 5 edit — 5 furniture pieces that earn their space
**Desc:** Linen sofa, oak nightstand pair, oak console, oak dining chairs, low oak bed. The five pieces I'd buy again. Tap each.
`#homedecor #livingroomdecor #oakfurniture #scandinavianstyle #neutralhome`
(As an Amazon Associate I earn from qualifying purchases.)

### Pin 182 | 12 PM | Bedroom | `day37-pin182-dresser-top.png`
**Title:** Dresser-top vignette
**Desc:** A small ribbed vase with a single dried branch, a stoneware tray for jewelry, a folded linen runner. Three items, one calm dresser. Tap each.
`#bedroomdecor #dresserdecor #styledvignette #neutralhome #homedecor`
(As an Amazon Associate I earn from qualifying purchases.)

### Pin 183 | 3 PM | Storage | `day37-pin183-woven-storage-trio.png`
**Title:** Woven storage trio
**Desc:** Three nested woven baskets — large, medium, small — for the corner of any room. Tap to shop the set.
`#homeorganization #storage #wovenbaskets #neutralhome #organization`
(As an Amazon Associate I earn from qualifying purchases.)

### Pin 184 | 7 PM | Outdoors | `day37-pin184-herb-pots.png`
**Title:** Stoneware herb pots
**Desc:** Three matching stoneware herb pots in oat with drainage trays. Basil, mint, rosemary on the kitchen sill. Tap to shop.
...
### Pin 186 | 8 AM | Bedroom | `day38-pin186-bedroom-refresh-getthelook.png`
**Title:** Get the look — a calm bedroom refresh
**Desc:** Linen duvet, oak nightstand pair, ceramic lamp, woven basket, framed art. Five anchor pieces for a complete bedroom. Tap each.
...
### Pin 188 | 3 PM | Lighting | `day38-pin188-bedside-reading-lamp.png`
**Title:** The bedside reading lamp
**Desc:** Articulated brass reading lamp on a stoneware base. Adjustable arm, warm bulb, no overhead light needed. Tap to shop.
...
### Pin 190 | 10 PM | Bedroom | `day38-pin190-bedside-books.png`
**Title:** Bedside books, styled
**Desc:** A small stack of three hardcovers with neutral spines, a stoneware mug, a single dried branch. The bedside that calms. Tap each book.
`#bedroomdecor #bookstack #styledvignette #cozyhome #neutralhome`
(As an Amazon Associate I earn from qualifying purchases.)
...
### Pin 192 | 12 PM | Office/Reading Nook | `day39-pin192-bedside-journal.png`
**Title:** The bedside journal moment
**Desc:** A leather-wrapped journal, a brass pen, a stoneware mug of tea on an oak nightstand. The five-minute morning. Tap to shop.
`#bedroomdecor #journaling #morningroutine #slowliving #cozyhome`
(As an Amazon Associate I earn from qualifying purchases.)

### Pin 193 | 3 PM | Lighting | `day39-pin193-stoneware-lamp-detail.png`
**Title:** Stoneware lamp, up close
**Desc:** Macro of a hand-thrown stoneware lamp base in oat with visible throw lines. The detail that makes the room. Tap to shop.
`#lighting #stoneware #ceramics #pottery #neutralhome`
(As an Amazon Associate I earn from qualifying purchases.)

### Pin 194 | 7 PM | Bedroom | `day39-pin194-morning-bed-moment.png`
**Title:** Morning bed moment
**Desc:** Pre-washed linen sheets in cream, soft morning light from the left, a stoneware mug on the nightstand. Sunday by design. Tap to shop the sheets.
...
### Pin 198 | 3 PM | Bedroom | `day40-pin198-four-pillows-bed.png`
**Title:** 4 pillows for a layered bed
**Desc:** Two euro shams in stone, two standard shams in cream. The four-pillow formula that styles any bed. Tap each.
`#bedroomdecor #bedstyling #pillowshams #linenbedding #neutralhome`
(As an Amazon Associate I earn from qualifying purchases.)

### Pin 199 | 7 PM | Lighting | `day40-pin199-bedroom-dimmer.png`
**Title:** The bedroom dimmer (the small upgrade)
**Desc:** Plug-in inline dimmer that fits any lamp, no rewiring. Bedroom lights that match the hour. Tap to shop.
...
### Pin 202 | 12 PM | Storage | `day41-pin202-under-bed-storage.png`
**Title:** Linen under-bed storage
**Desc:** Pair of linen under-bed storage boxes with handles, fits standard frames, hidden when you don't need it. Tap to shop.
...
### Pin 206 | 8 AM | Bedroom | `day42-pin206-alarm-clock.png`
**Title:** Alarm clock, not your phone
**Desc:** Small wooden bedside alarm clock with a soft warm display. The thing that lets the phone live in the kitchen. Tap to shop.
...
### Pin 208 | 3 PM | Storage | `day42-pin208-closet-transformed.png`
**Title:** Closet transformed
**Desc:** Matching wooden hangers, three linen storage cubes, a single dried branch, and a folded wool throw on a top shelf. Tap each item.
...
### Pin 210 | 10 PM | Decor accents | `day42-pin210-five-bedroom-rules.png`
**Title:** 5 rules for a quiet bedroom
**Desc:** No phone, dimmer on every lamp, blackout curtains, one warm sconce, sheets that don't crinkle. Five upgrades, one calm room.
`#bedroomdecor #sleepwell #cozyhome #bedroomideas #neutralhome`
(As an Amazon Associate I earn from qualifying purchases.)
...
When you have a moment: close `Pin Copy Library - UPDATED.md` in your editor, then either (a) paste the contents of this file at the bottom of that one (right before `## TAG ROTATION REMINDER`), or (b) leave both files side by side. Either works — both reference the same pin filenames in `final pins/02-affiliate-pins/`.
